            ...
            <>
                <View style={{ padding: 15 }}>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center' }}>
                        <TouchableOpacity onPress={() => this.handleInput(50000)} style={{ alignItems: 'center', justifyContent: 'center' }}>
                            <Image style={{ width: 50, height: 50 }} source={img.coin1} />
                            <Text style={{ fontWeight: 'bold', marginTop: 10 }}>Rp50.000</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.handleInput(100000)} style={{ alignItems: 'center', justifyContent: 'center' }}>
                            <Image style={{ width: 50, height: 50 }} source={img.coin2} />
                            <Text style={{ fontWeight: 'bold', marginTop: 10 }}>Rp100.000</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.handleInput(200000)} style={{ alignItems: 'center', justifyContent: 'center' }}>
                            <Image style={{ width: 50, height: 50 }} source={img.coin3} />
                            <Text style={{ fontWeight: 'bold', marginTop: 10 }}>Rp200.000</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => this.handleInput(500000)} style={{ alignItems: 'center', justifyContent: 'center' }}>
                ...
                <View style={{ padding: 15 }}>
                    ...
                    <View style={{ width: '100%'}}>
                        <TouchableOpacity disabled={true} style={{ paddingVertical: 15, backgroundColor: '#e8e8e8', borderRadius: 5, justifyContent: 'center', alignItems: 'center' }}>
